...
plot(x = powerconsumption$DateTime, y = powerconsumption$Voltage, xlab = "datetime", 
     ylab = "Voltage", type = "l")
...
legend(x = "topright", legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), 
       col =c("black", "red", "blue"), lwd = "1", xjust = "0", pt.cex = 1, cex = 0.4)

plot(x = powerconsumption$DateTime, y = powerconsumption$Global_reactive_power, xlab = "datetime", 
